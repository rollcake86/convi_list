                      ...
                      return new ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                                ...
                                child: new Column(
                                  children: <Widget>[
                                    ...
                                    new Padding(
                                      ...
                                      child: new Text(priceArray[index],
                                          style: new TextStyle(
                                              fontSize: counter.toDouble(),
                                              color: Colors.red),
                                          textAlign: TextAlign.start),
                              ...
                              onTap: () {
                                _onChange(_productName(viewArray[index]) +
                                    priceArray[index]);
                              },
                              onLongPress: () {
                                Clipboard.setData(new ClipboardData(
                                    text: _productName(viewArray[index]) +
                                        priceArray[index]));
